---
title: "STARLING"
description: Self-supervised Training of Text-based Reinforcement Learning Agent with Large Language Models
...
---
I completed this project with IBM researchers Dr. Keerthiram Murugesan and Mr. Shivam Ratnakar. This project is a continuation of ComplexWorld which we worked on previously. This work improves the existing project and we experiment with pre-training agents with the game we generate.
## Abstract
